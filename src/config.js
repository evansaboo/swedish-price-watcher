...
const supportedSourceTypes = new Set(['rss', 'html-page', 'html-list', 'komplett-category', 'komplett-sitemap', 'apify-elgiganten', 'apify-komplett', 'webhallen-api', 'netonnet-outlet', 'proshop-outlet', 'power-deals']);
